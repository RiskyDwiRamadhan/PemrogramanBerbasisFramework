                    ...
                    <table style={{ marginTop: "60px" }} className="table table-hover table-dark" >
                        ...
                        <tbody>
                            ...
                            <tr key={todo.id}>
                                ...
                                <td>
                                    <span className="fa fa-minus-circle" onClick={() => this.props.deleteTodo(todo.id)} style={{ color: "white", fontSize: "20pt", marginRight: "20px" }} />
                                    <span className="fa fa-check-circle" onClick={() => this.props.toggleTodo(todo.id)} style={{ color: "white", fontSize: "20pt" }} />
                                </td>
                            </tr>
                            ))}
                        </tbody>
